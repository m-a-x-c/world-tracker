...
const LANGUAGE_GROUPS = {
  ...
  arabicfrench:{ label: 'Arabic + French', color: '#a8e063' },
  ...
  hindi:      { label: 'Hindi, Marathi, Bengali, Tamil, Telugu', color: '#ff6680' },
...
const COUNTRY_LANGUAGE = {
  ...
  DZ:'arabicfrench', MA:'arabicfrench', TN:'arabicfrench',
  SD:'arabic', IQ:'arabic', SY:'arabic', YE:'arabic',
